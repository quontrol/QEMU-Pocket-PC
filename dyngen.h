...
#if defined(__sparc__) || (defined(__arm__) && !defined(UNDER_CE))
...
//	stop|=31;
//	stop++;
//	CacheRangeFlush((void*)start,stop-start,CACHE_SYNC_L2_WRITEBACK|CACHE_SYNC_WRITEBACK|CACHE_SYNC_INSTRUCTIONS|CACHE_SYNC_FLUSH_I_TLB);
	CacheRangeFlush((void*)start,stop-start,CACHE_SYNC_INSTRUCTIONS|CACHE_SYNC_WRITEBACK|CACHE_SYNC_FLUSH_TLB);
}
#else
static inline void flush_icache_range(unsigned long start, unsigned long stop)
{
