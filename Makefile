...
ifdef BUILD_DOCS
DOCS=
#qemu-doc.html qemu-tech.html qemu.1 qemu-img.1
else
DOCS=
endif
...
ifdef CONFIG_SDL
OBJS+=sdl.o x_keymap.o profile.o ce-except.o
endif
OBJS+=vnc.o d3des.o
...
sdl.o: sdl-ce.c keymaps.c sdl_keysym.h
	$(CC) $(CFLAGS) $(CPPFLAGS) $(SDL_CFLAGS) $(BASE_CFLAGS) -c -o $@ $<

ce-except.o: ce-except.c 
	$(CC) $(CFLAGS) $(CPPFLAGS) $(SDL_CFLAGS) $(BASE_CFLAGS) -c -o $@ $<
...
dyngen$(EXESUF): dyngen.c
	gcc $(CFLAGS) $(CPPFLAGS) $(BASE_CFLAGS) -o $@ $^
